...
namespace dbms_mini_pro
{
    public partial class Admin_Tenant_UserControl1 : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@No_of_BHK", BHKtextBox.Text);

            cmd.Parameters.AddWithValue("@Rent_Paid", Rent_PaidtextBox.Text);
            ...
            {   if (ex.Number == 2601 || ex.Number == 2627)
                    MessageBox.Show(" <<< flat already occupied\n");
