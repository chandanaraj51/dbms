...
namespace dbms_mini_pro
{
    public partial class Admin_Vacant_UserControl1 : UserControl
    {
        ...
        private void Delete_Tuple_Button_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("VacantFlatDelete_SP", con);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void SearchButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("VacantFlatSearch_SP", con);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@Flat_no", FlatSearch_textBox.Text);
        ...
        {
            Flat_no_textBox.Text = "";
            Block_no_textBox.Text = "";
            Floor_no_textBox.Text = "";
            No_of_BHK_textBox.Text = "";
            Rent_textBox.Text = "";
